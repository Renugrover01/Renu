...
public class Test_Search extends TestBaseSetup {
	...
	By jobTypeCount		= By.xpath("//*[@id='id_filters']/li[8]/div/ul/li[1]/ul/li[1]/em/b");
	//By.xpath("(//li[@id='id_filter_jobtype']/div/ul/li/em/b)[1]");
	...
	By relax_search_msg = By.cssSelector("u.relax");
	/*
	 * Search page object
	 */
	...
	public void TestSetup() {
		...
		_Utility.closeNotification(_Searchdriver);
	}
	...
	@Test(priority=15)
	public void test_loggedout_advance_search() throws Exception {
		advanceSearch();
		WebElement element = _Searchdriver.findElement(jobTitle);
		String strng = element.getText();
	...
	/*
	 * @Test(priority=16) public void verify_loggedout_realaxed_search() {
	 * _Searchdriver.navigate().to(baseUrl+"/job-search/python-jobs-in-uganda");
	 * test_relaxed_search(_Searchdriver); }
	 */
	...
	@Test(priority=17)
	/*
	 * public void test_loggedin_simple_search () { loggedInShine(_Searchdriver,
	 * email_main, pass_new); _Utility.Thread_Sleep(2000); //SIMPLE SEARCH
	 * simpleSearch("manager", _Searchdriver); _Utility.Thread_Sleep(3000);
	 * WebElement element; element = _Searchdriver.findElement(jobTitle); String
	 * strng = element.getText(); Assert.assertEquals(strng, "Manager Jobs"); }
	 */

	/*
	 * @Test(priority=18) public void test_loggedin_advance_search() {
	 * advanceSearch(); WebElement element = _Searchdriver.findElement(jobTitle);
	 * String strng = element.getText().toLowerCase(); Assert.assertEquals(strng,
	 * "android jobs in delhi"); }
	 */


	//@Test(priority=19)
	/*
	 * public void verify_loggedin_realaxed_search() {
	 * _Searchdriver.navigate().to(baseUrl+
	 * "/myshine/job-search/python-jobs-in-uganda");
	 * test_relaxed_search(_Searchdriver); }
	 */


	/*
	 * @Test (priority =21, dataProvider="searchdata") public void
	 * test_SearchMostViewedPages(String searchurl) { //test for most get of search
	 * result APP_LOGS.debug("-----------SEARCHING URL: "+searchurl+" -----------");
	 * _Searchdriver.navigate().to(baseUrl+searchurl);
	 * _Utility.clickOnNotification(_Searchdriver); String
	 * searchnum=_Searchdriver.findElement(jobCount).getText();
	 ...
	 */
	/*
	 * public void test_relaxed_search(WebDriver _Searchdriver) {
	 * _Utility.Thread_Sleep(2000); String actual_relax_msg =
	 * _Searchdriver.findElement(relax_search_msg).getText().trim();
	 * APP_LOGS.debug("Relax Search Message: "+actual_relax_msg);
	 * Assert.assertEquals(actual_relax_msg,
	 * "There are no jobs matching your exact search criteria. Showing jobs based on your search that could be relevant to you."
	 * ); }
	 */
	...
	public static void simpleSearch(String sKeyword, WebDriver _SimpleSearchdriver) {
		_SimpleSearchdriver.navigate().to(baseUrl + "/myshine/home/");
		_Utility.Thread_Sleep(2000);
		_Utility.clickOnNotification(_SimpleSearchdriver);
		_Utility.set_flag_checkTimeStamp(_SimpleSearchdriver);
	...
	public void advanceSearch() {
		_Searchdriver.navigate().to(baseUrl + "/myshine/home/");
		_Utility.Thread_Sleep(3000);
		_Utility.clickOnNotification(_Searchdriver);
		_Utility.set_flag_checkTimeStamp(_Searchdriver);
		...
		new Select(_Searchdriver.findElement(minExp)).selectByValue("8");
		...
		_Utility.Thread_Sleep(1000);
		new Select(_Searchdriver.findElement(minSal)).selectByValue("7");
